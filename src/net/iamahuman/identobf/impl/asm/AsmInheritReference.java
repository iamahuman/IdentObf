 ...
 */
public class AsmInheritReference extends AsmReference {

    final ClassNode node;

    public AsmInheritReference(AsmItem source, ClassNode node, boolean isStrong) {
    ...
    public void setIdentifier(Object newIdentifier) {
        node.superName = (String) newIdentifier;
    }
