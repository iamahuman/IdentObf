 ...
 */
public class AsmAnnotDefTypeListReference extends AsmTypeRefReference {
    final List<Object> list;
    final int index;

    protected AsmAnnotDefTypeListReference(AsmItem source, List<Object> list, int index, boolean isStrong) {
