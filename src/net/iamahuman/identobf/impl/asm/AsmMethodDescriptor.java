 ...
 */
public class AsmMethodDescriptor extends AsmDescriptor {
    final MethodNode node;

    public AsmMethodDescriptor(AsmItem root, boolean isStrong, MethodNode node) {
        super(root, isStrong);
        this.node = node;
    }
    ...
    protected void parse(DescriptorParser parser) throws DescriptorParser.ParseException {
        parser.parseMethodTypeSignature();
    }
}
