 ...
 */
public class AsmLVarTypeDescriptor extends AsmDescriptor {
    final LocalVariableNode node;
    public AsmLVarTypeDescriptor(AsmItem root, boolean isStrong, LocalVariableNode node) {
        super(root, isStrong);
        this.node = node;
    }
    ...
    protected void parse(DescriptorParser parser) throws DescriptorParser.ParseException {
        parser.parseFieldTypeSignature();
    }
}
