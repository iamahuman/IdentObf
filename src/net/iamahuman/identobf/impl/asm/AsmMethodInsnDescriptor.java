 ...
 */
public class AsmMethodInsnDescriptor extends AsmDescriptor {
    final MethodInsnNode insn;
    public AsmMethodInsnDescriptor(AsmItem root, boolean isStrong, MethodInsnNode insn) {
        super(root, isStrong);
        this.insn = insn;
    }
