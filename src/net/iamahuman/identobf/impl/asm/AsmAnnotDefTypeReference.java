 ...
 */
public class AsmAnnotDefTypeReference extends AsmTypeRefReference {

    final MethodNode node;

    protected AsmAnnotDefTypeReference(AsmItem source, MethodNode node, boolean isStrong) {
    ...
    protected Type getTypeRef() {
        return (Type) node.annotationDefault;
    }

    @Override
    protected void setTypeRef(Type newType) {
        node.annotationDefault = newType;
    }
}
