 ...
 */
public class AsmTryCatchBlockTypeReference extends AsmReference {
    final TryCatchBlockNode node;
    AsmTryCatchBlockTypeReference(AsmItem source, TryCatchBlockNode node, boolean isStrong) {
    ...
    public void setIdentifier(Object newIdentifier) {
        node.type = (String) newIdentifier;
    }
}
